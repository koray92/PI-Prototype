...
function connectDB(tx) {
    return __awaiter(this, void 0, void 0, function () {
        var query, userId, query, userId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(tx.transactionType == 'Sale')) return [3 /*break*/, 5];
                    return [4 /*yield*/, prisma.user_wallet.findUnique({
                            where: {
                                wallet_id: tx.to,
                            }
                        })];
                ...
                case 5: return [4 /*yield*/, prisma.user_wallet.findUnique({
                        where: {
                            wallet_id: tx.from,
                        }
                    })];
