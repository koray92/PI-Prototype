...
const CTA = () => (
    <section className={'bg-black-gradient-2 rounded-[20px] box-shadow'}>
        <section id="contact" className="mt-[80px]">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                    ...
                    <button className="py-4 px-6 font-poppins font-medium text-[18px] text-primary bg-blue-gradient rounded-[10px] outline-none">
                        Send Message
                    </button>
                </form>
